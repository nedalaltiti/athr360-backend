...
FLOW_RULES = dedent(
    ...
    - Ticket link → "Open a Compliance PDPL support request
    - **When you don't have knowledge**: Add "For further help, you can submit a ticket at our Compliance PDPL Support
    ...
    • **Notice Period:**
      - If you have completed your probation period: one-month notice period as per KSA labor law
