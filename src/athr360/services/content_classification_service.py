...
class ContentClassificationService:
    ...
    This service adapts responses based on the current app instance (region),
            ensuring appropriate crisis resources, emergency numbers, and Compliance PDPL contacts.
    """
...
"""
        ...
        prompt = f"""You are an expert conversation flow analyst for a Compliance PDPL Assistant serving {self.app_config.name}. Analyze this user message to determine conversation flow and smart feedback timing.
...
**CONTINUE_REDIRECTED** - Off-topic questions redirected to Compliance PDPL
...
Analyze the message:"""
    ...
    def get_response_message(self, analysis: ConversationAnalysis) -> Optional[str]:
        ...
        if analysis.flow_type == ConversationFlow.END_SAFETY_INTERVENTION:
            ...
            return "I'm here to help with Compliance PDPL and workplace-related questions."
