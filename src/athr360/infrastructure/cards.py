...
from athr360.infrastructure.cards_brand import BRAND, brand_header
    ...
    return {
        ...
        "body": [
            ...
            brand_header(header),
            {
                "type": "TextBlock",
                "text": (
                        "I'm your Compliance PDPL Assistant  👋. I'm here to help you with any "
                "Compliance PDPL-related questions or requests you may have."
                ),
                "wrap": True,
                "spacing": "Medium",
            },
...
def create_feedback_card(selected_rating: int = 0, *, interactive: bool = True, existing_comment: str = ""):
    ...
    card = {
        ...
        "body": [
            ...
            {
                "type": "TextBlock",
                "text": "How would you rate your experience with our Compliance PDPL Assistant?",
                "wrap": True
            },
            {
                "type": "ColumnSet",
